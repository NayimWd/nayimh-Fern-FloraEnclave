  ...
  return (
    <div className=" flex  w-full flex-col items-center justify-center overflow-hidden">
              ...
              <div className="text-center mt-4 ">
                  <h1 className="cursor-pointer text-black hover:text-dark_green font-bold font-jost tracking-wider leading-6 "> {title} </h1>
                  <p className="text-dark_green font-bold mt-1 font-lato"> &#2547; {price}</p>
              </div>
